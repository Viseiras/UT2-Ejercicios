...
public class ej2ConexioGrafica extends javax.swing.JFrame {
    
    /** Creates new form DialogoConexion */
    public ej2ConexioGrafica() {
        initComponents();
    }
...
// TODO add your handling code here:
        ...
        try {
            ...
            //jTextAreaDetalle.append("Registrando " + driver + '\n');
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ej2ConexioGrafica d = new ej2ConexioGrafica();
                d.setSize(400,400);
                d.setVisible(true);
            }
        });
